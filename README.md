...
<img src="https://github.com/susimsek/golang-app-vagrant-ci-cd-with-jenkins/blob/main/images/vagrant-k8s-installation.png?v=3" alt="Golang Vagrant Kubernetes Installation" width="100%" height="100%"/> 
